...
class DataLoader:
    ...
    def __init__(self, root: str, config_filename: str = None) -> None:
        """Initialize DataLoader with data from config.

        Args:
            root: str
            config_filename: str - default 'default.yaml'
        """
        if config_filename is None:
            config_filename = os.path.abspath(resource_filename('dataloader.config', 'default.yaml'))
